...
public final class Fonts {
    ...
    private static final String XOLONIUM_REGULAR_NAME;
    private static final String XOLONIUM_BOLD_NAME;
    ...
    private static String xoloniumRegularName;
    private static String xoloniumBoldName;


    static {
        try {
            bebasNeueName          = Font.loadFont(Fonts.class.getResourceAsStream("bebasneue.otf"), 10).getName();
            digitalName            = Font.loadFont(Fonts.class.getResourceAsStream("digital.ttf"), 10).getName();
            digitalReadoutName     = Font.loadFont(Fonts.class.getResourceAsStream("digitalreadout.ttf"), 10).getName();
            digitalReadoutBoldName = Font.loadFont(Fonts.class.getResourceAsStream("digitalreadoutb.ttf"), 10).getName();
            dinFunName             = Font.loadFont(Fonts.class.getResourceAsStream("din.otf"), 10).getName();
            elektraName            = Font.loadFont(Fonts.class.getResourceAsStream("elektra.ttf"), 10).getName();
            ...
            latoHairlineName       = Font.loadFont(Fonts.class.getResourceAsStream("Lato-Hai.ttf"), 10).getName();
            latoLightName          = Font.loadFont(Fonts.class.getResourceAsStream("Lato-Lig.ttf"), 10).getName();
            latoRegularName        = Font.loadFont(Fonts.class.getResourceAsStream("Lato-Reg.ttf"), 10).getName();
            latoBoldName           = Font.loadFont(Fonts.class.getResourceAsStream("Lato-Bol.ttf"), 10).getName();
            latoBlackName          = Font.loadFont(Fonts.class.getResourceAsStream("Lato-Bla.ttf"), 10).getName();
            xoloniumRegularName    = Font.loadFont(Fonts.class.getResourceAsStream("Xolonium-Regular.otf"), 10).getName();
            xoloniumBoldName       = Font.loadFont(Fonts.class.getResourceAsStream("Xolonium-Bold.otf"), 10).getName();
        ...
        XOLONIUM_REGULAR_NAME     = xoloniumRegularName;
        XOLONIUM_BOLD_NAME        = xoloniumBoldName;
    }
    ...
    public static Font xoloniumRegular(final double SIZE){
        return new Font(XOLONIUM_REGULAR_NAME, SIZE);
    }
    public static Font xoloniumBold(final double SIZE){
        return new Font(XOLONIUM_BOLD_NAME, SIZE);
    }
}
