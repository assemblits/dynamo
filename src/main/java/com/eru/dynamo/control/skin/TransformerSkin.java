 ...
 */
public class TransformerSkin extends SkinBase<Transformer> {
    ...
    private void updateState() {
        transformer.setStyle(getSkinnable().getEnergized() ? "-fx-background-color:-energized-color" : "-fx-background-color:-de-energized-color");
    }
}
